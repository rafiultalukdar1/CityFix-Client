        ...
        <>
            <div className='py-[55px] md:py-[70px] lg:py-[95px] bg-[#FBFCFB] dark:bg-gray-900'>
                <div className='container'>
                    <h2 data-aos="fade-up" className='text-center text-[30px] sm:text-[40px] lg:text-[50px] font-bold'>Recently Resolved Issues</h2>
                    <p data-aos="fade-up" className='text-[16px] md:text-[18px] font-medium text-[#6D7873] text-center max-w-[620px] mx-auto'>See how we're making a difference in our community. These issues were recently resolved thanks to citizen reports and our dedicated team.</p>


                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-[35px] md:mt-[50px]'>
                        {issues.map(issue => (
                            <div data-aos="fade-up" key={issue._id} className='shadow-sm dark:shadow-md rounded-lg bg-white dark:bg-[#1D232A]'>
